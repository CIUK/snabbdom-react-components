...
var d=s.indexOf("#"),y=s.indexOf(".",d),u=0<d?d:s.length,g=0<y?y:s.length,m=-1!==d||-1!==y?s.slice(0,o(u,g)):s;if(l=e.elm=isDef(r)&&isDef(c=r.ns)?t.createElementNS(c,m):t.createElement(m),u<g&&(l.id=s.slice(u+1,g)),0<y&&(l.className=s.slice(g+1).replace(/\./g," ")),is.array(p))for(c=0;c<p.length;++c)t.appendChild(l,a(p[c],n));else is.primitive(e.text)&&t.appendChild(l,t.createTextNode(e.text));for(c=0;c<h.create.length;++c)h.create[c](emptyNode,e);c=e.data.hook,isDef(c)&&(c.create&&c.create(emptyNode,e),c.insert&&n.push(e))}else l=e.elm=t.createTextNode(e.text);return e.elm}function c(e,n,o,c,i,r){for(;c<=i;++c)t.insertBefore(e,a(o[c],r),n)}function r(e){var t,n,o=e.data;if(isDef(o)){for(isDef(t=o.hook)&&isDef(t=t.destroy)&&t(e),t=0;t<h.destroy.length;++t)h.destroy[t](e);if(isDef(t=e.children))for(n=0;n<e.children.length;++n)r(e.children[n])}}function l(e,n,a,c){for(;a<=c;++a){var i=void 0,l=void 0,p=void 0,s=n[a];if(isDef(s))if(isDef(s.sel)){for(r(s),l=h.remove.length+1,p=o(s.elm,l),i=0;i<h.remove.length;++i)h.remove[i](s,p);isDef(i=s.data)&&isDef(i=i.hook)&&isDef(i=i.remove)?i(s,p):p()}else// Text node
t.removeChild(e,s.elm)}}function p(e,n,o,i){for(var r,p,d,y,h=0,u=0,g=n.length-1,m=n[0],f=n[g],k=o.length-1,_=o[0],b=o[k];h<=g&&u<=k;)isUndef(m)?m=n[++h]:isUndef(f)?f=n[--g]:sameVnode(m,_)?(s(m,_,i),m=n[++h],_=o[++u]):sameVnode(f,b)?(s(f,b,i),f=n[--g],b=o[--k]):sameVnode(m,b)?(// Vnode moved right
