...
v=t.regeneratorRuntime=e.exports,v.wrap=n;var w={},j={};j[_]=function(){return this};var W=Object.getPrototypeOf,C=W&&W(W(u([])));C&&C!==g&&f.call(C,_)&&(j=C);var P=r.prototype=a.prototype=Object.create(j);// Within the body of any async function, `await x` is transformed to
...
c.prototype=P.constructor=r,r.constructor=c,r[x]=c.displayName="GeneratorFunction",v.isGeneratorFunction=function(e){var t="function"==typeof e&&e.constructor;return!!t&&(t===c||// For the native GeneratorFunction constructor, the best we can
// do is to check its .name property.
"GeneratorFunction"===(t.displayName||t.name))},v.mark=function(e){return Object.setPrototypeOf?Object.setPrototypeOf(e,r):(e.__proto__=r,!(x in e)&&(e[x]="GeneratorFunction")),e.prototype=Object.create(P),e},v.awrap=function(e){return{__await:e}},i(l.prototype),l.prototype[b]=function(){return this},v.AsyncIterator=l,v.async=function(e,t,o,a){var c=new l(n(e,t,o,a));return v.isGeneratorFunction(t)?c// If outerFn is a generator, return the full iterator.
:c.next().then(function(e){return e.done?e.value:c.next()})},i(P),P[x]="Generator",P[_]=function(){return this},P.toString=function(){return"[object Generator]"},v.keys=function(e){var t=[];for(var n in e)t.push(n);// Rather than returning an object with a next method, we keep
