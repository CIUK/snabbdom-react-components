"use strict";Object.defineProperty(exports,"__esModule",{value:!0});function _interopDefault(e){return e&&"object"==typeof e&&"default"in e?e["default"]:e}var lodash=require("lodash"),lodash__default=_interopDefault(lodash),commonjsGlobal="undefined"==typeof window?"undefined"==typeof global?"undefined"==typeof self?{}:self:global:window;function createCommonjsModule(e,t){return t={exports:{}},e(t,t.exports),t.exports}var runtime=createCommonjsModule(function(e){/**
...
var i=t&&t.prototype instanceof a?t:a,c=Object.create(i.prototype),r=new u(o||[]);return c._invoke=p(e,n,r),c}// Try/catch helper to minimize deoptimizations. Returns a completion
...
function a(){}function i(){}function c(){}// This is a polyfill for %IteratorPrototype% for environments that
// don't natively support it.
// Helper for defining the .next, .throw, and .return methods of the
// Iterator interface in terms of a single ._invoke method.
function r(e){["next","throw","return"].forEach(function(t){e[t]=function(e){return this._invoke(t,e)}})}function l(e){function t(n,a,i,c){var r=o(e[n],e,a);if("throw"===r.type)c(r.arg);else{var l=r.arg,p=l.value;return p&&"object"==typeof p&&f.call(p,"__await")?Promise.resolve(p.__await).then(function(e){t("next",e,i,c)},function(e){t("throw",e,i,c)}):Promise.resolve(p).then(function(e){// When a yielded Promise is resolved, its final value becomes
// the .value of the Promise<{value,done}> result for the
// current iteration.
l.value=e,i(l)},function(e){// If a rejected Promise was yielded, throw the rejection back
// into the async generator function so it can be handled there.
return t("throw",e,i,c)})}}function n(e,n){function o(){return new Promise(function(o,a){t(e,n,o,a)})}return a=// If enqueue has been called before, then we want to wait until
...
var a;this._invoke=n}function p(e,t,n){var a="suspendedStart";return function(i,c){if(a==="executing")throw new Error("Generator is already running");if("completed"===a){if("throw"===i)throw c;// Be forgiving, per 25.3.3.3.3 of the spec:
// https://people.mozilla.org/~jorendorff/es6-draft.html#sec-generatorresume
return m()}for(n.method=i,n.arg=c;;){var r=n.delegate;if(r){var l=s(r,n);if(l){if(l===v)continue;return l}}if("next"===n.method)// Setting context._sent for legacy support of Babel's
// function.sent implementation.
n.sent=n._sent=n.arg;else if("throw"===n.method){if("suspendedStart"===a)throw a="completed",n.arg;n.dispatchException(n.arg)}else"return"===n.method&&n.abrupt("return",n.arg);a="executing";var p=o(e,t,n);if("normal"===p.type){if(a=n.done?"completed":"suspendedYield",p.arg===v)continue;return{value:p.arg,done:n.done}}"throw"===p.type&&(// Dispatch the exception by looping back around to the
...
return v;t.method="throw",t.arg=new TypeError("The iterator does not provide a 'throw' method")}return v}var a=o(n,e.iterator,t.arg);if("throw"===a.type)return t.method="throw",t.arg=a.arg,t.delegate=null,v;var i=a.arg;if(!i)return t.method="throw",t.arg=new TypeError("iterator result is not an object"),t.delegate=null,v;if(i.done)t[e.resultName]=i.value,t.next=e.nextLoc,"return"!==t.method&&(t.method="next",t.arg=void 0);else// Re-yield the result returned by the delegate method.
return i;// The delegate iterator is finished, so forget it and continue with
// the outer generator.
return t.delegate=null,v}// Define Generator.prototype.{next,throw,return} in terms of the
// unified ._invoke helper method.
function d(e){var t={tryLoc:e[0]};1 in e&&(t.catchLoc=e[1]),2 in e&&(t.finallyLoc=e[2],t.afterLoc=e[3]),this.tryEntries.push(t)}function y(e){var t=e.completion||{};t.type="normal",delete t.arg,e.completion=t}function u(e){// The root entry object (effectively a try statement without a catch
// or a finally block) gives us a place to store values thrown from
// locations where there is no enclosing try statement.
this.tryEntries=[{tryLoc:"root"}],e.forEach(d,this),this.reset(!0)}function h(e){if(e){var t=e[k];if(t)return t.call(e);if("function"==typeof e.next)return e;if(!isNaN(e.length)){var n=-1,o=function t(){for(;++n<e.length;)if(f.call(e,n))return t.value=e[n],t.done=!1,t;return t.value=void 0,t.done=!0,t};return o.next=o}}// Return an iterator with no values.
return{next:m}}function m(){return{value:void 0,done:!0}}var g=Object.prototype,f=g.hasOwnProperty,_="function"==typeof Symbol?Symbol:{},k=_.iterator||"@@iterator",b=_.asyncIterator||"@@asyncIterator",x=_.toStringTag||"@@toStringTag",w=t.regeneratorRuntime;if(w)// Don't bother evaluating the rest of this file if the runtime was
// already defined globally.
return void(// If regeneratorRuntime is defined globally and we're in a module,
// make the exports object identical to regeneratorRuntime.
e.exports=w);// Define the runtime globally (as expected by generated code) as either
// module.exports (if we're in a module) or a new, empty object.
w=t.regeneratorRuntime=e.exports,w.wrap=n;var v={},j={};j[k]=function(){return this};var C=Object.getPrototypeOf,W=C&&C(C(h([])));W&&W!==g&&f.call(W,k)&&(j=W);var O=c.prototype=a.prototype=Object.create(j);// Within the body of any async function, `await x` is transformed to
...
i.prototype=O.constructor=c,c.constructor=i,c[x]=i.displayName="GeneratorFunction",w.isGeneratorFunction=function(e){var t="function"==typeof e&&e.constructor;return!!t&&(t===i||// For the native GeneratorFunction constructor, the best we can
// do is to check its .name property.
"GeneratorFunction"===(t.displayName||t.name))},w.mark=function(e){return Object.setPrototypeOf?Object.setPrototypeOf(e,c):(e.__proto__=c,!(x in e)&&(e[x]="GeneratorFunction")),e.prototype=Object.create(O),e},w.awrap=function(e){return{__await:e}},r(l.prototype),l.prototype[b]=function(){return this},w.AsyncIterator=l,w.async=function(e,t,o,a){var i=new l(n(e,t,o,a));return w.isGeneratorFunction(t)?i// If outerFn is a generator, return the full iterator.
:i.next().then(function(e){return e.done?e.value:i.next()})},r(O),O[x]="Generator",O[k]=function(){return this},O.toString=function(){return"[object Generator]"},w.keys=function(e){var t=[];for(var n in e)t.push(n);// Rather than returning an object with a next method, we keep
...
return n.done=!0,n}},w.values=h,u.prototype={constructor:u,reset:function(e){if(this.prev=0,this.next=0,this.sent=this._sent=void 0,this.done=!1,this.delegate=null,this.method="next",this.arg=void 0,this.tryEntries.forEach(y),!e)for(var t in this)// Not sure about the optimal order of these conditions:
...
try{delete g.regeneratorRuntime}catch(t){g.regeneratorRuntime=void 0}var regenerator=runtimeModule;function asyncGeneratorStep(e,t,n,o,a,i,c){try{var r=e[i](c),l=r.value}catch(e){return void n(e)}r.done?t(l):Promise.resolve(l).then(o,a)}function _asyncToGenerator(e){return function(){var t=this,n=arguments;return new Promise(function(o,a){function i(e){asyncGeneratorStep(r,o,a,i,c,"next",e)}function c(e){asyncGeneratorStep(r,o,a,i,c,"throw",e)}var r=e.apply(t,n);i(void 0)})}}var asyncToGenerator=_asyncToGenerator,vnode=function(e,t,n,o,a){var i=t===void 0?void 0:t.key;return{sel:e,data:t,children:n,text:o,elm:a,key:i}},is={array:Array.isArray,primitive:function(e){return"string"==typeof e||"number"==typeof e}};function addNS(e,t){if(e.ns="http://www.w3.org/2000/svg",void 0!==t)for(var n=0;n<t.length;++n)addNS(t[n].data,t[n].children)}var h=function(e,t,n){var o,a,c,r={};if(3===arguments.length?(r=t,is.array(n)?o=n:is.primitive(n)&&(a=n)):2===arguments.length&&(is.array(t)?o=t:is.primitive(t)?a=t:r=t),is.array(o))for(c=0;c<o.length;++c)is.primitive(o[c])&&(o[c]=vnode(void 0,void 0,void 0,o[c]));return"s"===e[0]&&"v"===e[1]&&"g"===e[2]&&addNS(r,o),vnode(e,r,o,a,void 0)};function createElement(e){return document.createElement(e)}function createElementNS(e,t){return document.createElementNS(e,t)}function createTextNode(e){return document.createTextNode(e)}function insertBefore(e,t,n){e.insertBefore(t,n)}function removeChild(e,t){e.removeChild(t)}function appendChild(e,t){e.appendChild(t)}function parentNode(e){return e.parentElement}function nextSibling(e){return e.nextSibling}function tagName(e){return e.tagName}function setTextContent(e,t){e.textContent=t}var htmldomapi={createElement:createElement,createElementNS:createElementNS,createTextNode:createTextNode,appendChild:appendChild,removeChild:removeChild,insertBefore:insertBefore,parentNode:parentNode,nextSibling:nextSibling,tagName:tagName,setTextContent:setTextContent};function isUndef(e){return e===void 0}function isDef(e){return e!==void 0}var emptyNode=vnode("",{},[],void 0,void 0);function sameVnode(e,t){return e.key===t.key&&e.sel===t.sel}function createKeyToOldIdx(e,t,n){var o,a,c={};for(o=t;o<=n;++o)a=e[o].key,isDef(a)&&(c[a]=o);return c}var hooks=["create","update","remove","destroy","pre","post"];function init(e,t){function n(e){return vnode(t.tagName(e).toLowerCase(),{},[],void 0,e)}function o(e,n){return function(){if(0==--n){var o=t.parentNode(e);t.removeChild(o,e)}}}function a(e,n){var c,o=Math.min,r=e.data;isDef(r)&&isDef(c=r.hook)&&isDef(c=c.init)&&(c(e),r=e.data);var l,p=e.children,s=e.sel;if(isDef(s)){// Parse selector
var d=s.indexOf("#"),y=s.indexOf(".",d),h=0<d?d:s.length,m=0<y?y:s.length,g=-1!==d||-1!==y?s.slice(0,o(h,m)):s;if(l=e.elm=isDef(r)&&isDef(c=r.ns)?t.createElementNS(c,g):t.createElement(g),h<m&&(l.id=s.slice(h+1,m)),0<y&&(l.className=s.slice(m+1).replace(/\./g," ")),is.array(p))for(c=0;c<p.length;++c)t.appendChild(l,a(p[c],n));else is.primitive(e.text)&&t.appendChild(l,t.createTextNode(e.text));for(c=0;c<u.create.length;++c)u.create[c](emptyNode,e);c=e.data.hook,isDef(c)&&(c.create&&c.create(emptyNode,e),c.insert&&n.push(e))}else l=e.elm=t.createTextNode(e.text);return e.elm}function c(e,n,o,i,c,r){for(;i<=c;++i)t.insertBefore(e,a(o[i],r),n)}function r(e){var t,n,o=e.data;if(isDef(o)){for(isDef(t=o.hook)&&isDef(t=t.destroy)&&t(e),t=0;t<u.destroy.length;++t)u.destroy[t](e);if(isDef(t=e.children))for(n=0;n<e.children.length;++n)r(e.children[n])}}function l(e,n,a,c){for(;a<=c;++a){var l,p,s,d=n[a];if(isDef(d))if(isDef(d.sel)){for(r(d),p=u.remove.length+1,s=o(d.elm,p),l=0;l<u.remove.length;++l)u.remove[l](d,s);isDef(l=d.data)&&isDef(l=l.hook)&&isDef(l=l.remove)?l(d,s):s()}else// Text node
t.removeChild(e,d.elm)}}function p(e,n,o,i){for(var r,p,d,y,u=0,h=0,m=n.length-1,g=n[0],f=n[m],_=o.length-1,k=o[0],b=o[_];u<=m&&h<=_;)isUndef(g)?g=n[++u]:isUndef(f)?f=n[--m]:sameVnode(g,k)?(s(g,k,i),g=n[++u],k=o[++h]):sameVnode(f,b)?(s(f,b,i),f=n[--m],b=o[--_]):sameVnode(g,b)?(// Vnode moved right
s(g,b,i),t.insertBefore(e,g.elm,t.nextSibling(f.elm)),g=n[++u],b=o[--_]):sameVnode(f,k)?(// Vnode moved left
s(f,k,i),t.insertBefore(e,f.elm,g.elm),f=n[--m],k=o[++h]):(isUndef(r)&&(r=createKeyToOldIdx(n,u,m)),p=r[k.key],isUndef(p)?(t.insertBefore(e,a(k,i),g.elm),k=o[++h]):(d=n[p],s(d,k,i),n[p]=void 0,t.insertBefore(e,d.elm,g.elm),k=o[++h]));u>m?(y=isUndef(o[_+1])?null:o[_+1].elm,c(e,y,o,h,_,i)):h>_&&l(e,n,u,m)}function s(e,n,o){var r,s;isDef(r=n.data)&&isDef(s=r.hook)&&isDef(r=s.prepatch)&&r(e,n);var d=n.elm=e.elm,y=e.children,h=n.children;if(e!==n){if(!sameVnode(e,n)){var m=t.parentNode(e.elm);return d=a(n,o),t.insertBefore(m,d,e.elm),void l(m,[e],0,0)}if(isDef(n.data)){for(r=0;r<u.update.length;++r)u.update[r](e,n);r=n.data.hook,isDef(r)&&isDef(r=r.update)&&r(e,n)}isUndef(n.text)?isDef(y)&&isDef(h)?y!==h&&p(d,y,h,o):isDef(h)?(isDef(e.text)&&t.setTextContent(d,""),c(d,null,h,0,h.length-1,o)):isDef(y)?l(d,y,0,y.length-1):isDef(e.text)&&t.setTextContent(d,""):e.text!==n.text&&t.setTextContent(d,n.text),isDef(s)&&isDef(r=s.postpatch)&&r(e,n)}}var d,y,u={};for(isUndef(t)&&(t=htmldomapi),d=0;d<hooks.length;++d)for(u[hooks[d]]=[],y=0;y<e.length;++y)void 0!==e[y][hooks[d]]&&u[hooks[d]].push(e[y][hooks[d]]);return function(e,o){var c,r,p,d=[];for(c=0;c<u.pre.length;++c)u.pre[c]();for(isUndef(e.sel)&&(e=n(e)),sameVnode(e,o)?s(e,o,d):(r=e.elm,p=t.parentNode(r),a(o,d),null!==p&&(t.insertBefore(p,o.elm,t.nextSibling(r)),l(p,[e],0,0))),c=0;c<d.length;++c)d[c].data.hook.insert(d[c]);for(c=0;c<u.post.length;++c)u.post[c]();return o}}var snabbdom={init:init};function updateClass(e,t){var n,o,a=t.elm,i=e.data.class||{},c=t.data.class||{};for(o in i)c[o]||a.classList.remove(o);for(o in c)n=c[o],n!==i[o]&&a.classList[n?"add":"remove"](o)}var _class={create:updateClass,update:updateClass};function updateProps(e,t){var n,o,a,i=t.elm,c=e.data.props||{},r=t.data.props||{};for(n in c)r[n]||delete i[n];for(n in r)o=r[n],a=c[n],a!==o&&("value"!==n||i[n]!==o)&&(i[n]=o)}for(var props={create:updateProps,update:updateProps},booleanAttrs=["allowfullscreen","async","autofocus","autoplay","checked","compact","controls","declare","default","defaultchecked","defaultmuted","defaultselected","defer","disabled","draggable","enabled","formnovalidate","hidden","indeterminate","inert","ismap","itemscope","loop","multiple","muted","nohref","noresize","noshade","novalidate","nowrap","open","pauseonexit","readonly","required","reversed","scoped","seamless","selected","sortable","spellcheck","translate","truespeed","typemustmatch","visible"],booleanAttrsDict={},i=0,len=booleanAttrs.length;i<len;i++)booleanAttrsDict[booleanAttrs[i]]=!0;function updateAttrs(e,t){var n,o,a,i=t.elm,c=e.data.attrs||{},r=t.data.attrs||{};// update modified attributes, add new attributes
for(n in r)o=r[n],a=c[n],a!==o&&(!o&&booleanAttrsDict[n]?i.removeAttribute(n):i.setAttribute(n,o));//remove removed attributes
// use `in` operator since the previous `for` iteration uses it (.i.e. add even attributes with undefined value)
// the other option is to remove all attributes with value == undefined
for(n in c)n in r||i.removeAttribute(n)}var attributes={create:updateAttrs,update:updateAttrs},raf="undefined"!=typeof window&&window.requestAnimationFrame||setTimeout,nextFrame=function(e){raf(function(){raf(e)})};function setNextFrame(e,t,n){nextFrame(function(){e[t]=n})}function updateStyle(e,t){if("string"==typeof t.data.style)return void(t.elm.style=t.data.style);var n,o,a=t.elm,i=e.data.style||{},c=t.data.style||{},r="delayed"in i;for(o in i)c[o]||(a.style[o]="");for(o in c)if(n=c[o],"delayed"===o)for(o in c.delayed)n=c.delayed[o],r&&n===i.delayed[o]||setNextFrame(a.style,o,n);else"remove"!==o&&n!==i[o]&&(a.style[o]=n)}function applyDestroyStyle(e){var t,n,o=e.elm,a=e.data.style;if(a&&(t=a.destroy))for(n in t)o.style[n]=t[n]}function applyRemoveStyle(e,t){var n=e.data.style;if(!n||!n.remove)return void t();var o,a,c=e.elm,r=0,l=n.remove,p=0,s=[];for(o in l)s.push(o),c.style[o]=l[o];a=getComputedStyle(c);for(var d=a["transition-property"].split(", ");r<d.length;++r)-1!==s.indexOf(d[r])&&p++;c.addEventListener("transitionend",function(e){e.target===c&&--p,0===p&&t()})}var style={create:updateStyle,update:updateStyle,destroy:applyDestroyStyle,remove:applyRemoveStyle};function arrInvoker(e){return function(){// Special case when length is two, for performance
2===e.length?e[0](e[1]):e[0].apply(void 0,e.slice(1))}}function fnInvoker(e){return function(t){e.fn(t)}}function updateEventListeners(e,t){var n,o,a,c=t.elm,r=e.data.on||{},l=t.data.on;if(l)for(n in l)if(o=l[n],a=r[n],void 0===a)is.array(o)?c.addEventListener(n,arrInvoker(o)):(o={fn:o},l[n]=o,c.addEventListener(n,fnInvoker(o)));else if(is.array(a)){a.length=o.length;for(var p=0;p<a.length;++p)a[p]=o[p];l[n]=a}else a.fn=o,l[n]=a}var eventlisteners={create:updateEventListeners,update:updateEventListeners},patch=snabbdom.init([_class,props,attributes,style,eventlisteners]),isFunction=lodash__default.isFunction,isArray=lodash__default.isArray,isString=lodash__default.isString,getLoader=function(e){var t=e;return isFunction(t)&&(t=t(),!isArray(t)&&(t=[t])),isString(t)||isArray(t)||(t=[t]),t},lazy=function(e,t){return function(n){return h("div",{hook:{insert:function(){var t=asyncToGenerator(/*#__PURE__*/regenerator.mark(function t(o){var a;return regenerator.wrap(function(t){for(;;)switch(t.prev=t.next){case 0:return t.next=2,e(n);case 2:a=t.sent,patch(o,a);case 4:case"end":return t.stop();}},t,this)}));return function(){return t.apply(this,arguments)}}()}},getLoader(t))}},lazy_1=lazy;function _arrayWithHoles(e){if(Array.isArray(e))return e}var arrayWithHoles=_arrayWithHoles;function _iterableToArrayLimit(e,t){var n=[],o=!0,a=!1,i=void 0;try{for(var c,r=e[Symbol.iterator]();!(o=(c=r.next()).done)&&(n.push(c.value),!(t&&n.length===t));o=!0);}catch(e){a=!0,i=e}finally{try{o||null==r["return"]||r["return"]()}finally{if(a)throw i}}return n}var iterableToArrayLimit=_iterableToArrayLimit;function _nonIterableRest(){throw new TypeError("Invalid attempt to destructure non-iterable instance")}var nonIterableRest=_nonIterableRest;function _slicedToArray(e,t){return arrayWithHoles(e)||iterableToArrayLimit(e,t)||nonIterableRest()}var slicedToArray=_slicedToArray;function toProperty(e){return"-"===e.charAt(0)&&(e=e.slice(0)),e.replace(/[^a-z0-9]([a-z0-9])?/gi,function(e,t){return t?t.toUpperCase():""})}function tokenizer(e){for(var t=["\r\n","\n\r","\n","\r"],n=["{","}",":",";"],o=["{","}",";"],a=[],c="",r="\0",l="\0",p="\0",s=null,d=!1,y=0;y<e.length;y++)if(y&&(r=e.charAt(y-1)),p=e.charAt(y),y+1<e.length&&(l=e.charAt(y+1)),!(~t.indexOf(p)&&~t.indexOf(r))){if(s=d?n:o,~s.indexOf(p)){"{"===p&&(d=!0),"}"===p&&(d=!1),a.push(c),a.push(p),c="";continue}c+=p}c&&a.push(c);var u=a.map(function(e){return e.trim()}).filter(function(e){return e&&";"!==e});return u}var cssToJS=function(e){var t=tokenizer(e),n={};return t.forEach(function(e){var t=e.split(":"),o=slicedToArray(t,2),a=o[0],i=o[1];a=a.trim(),i=i?i.trim():"",n[toProperty(a)]=i}),n};/**
...
Stack.prototype.clear=_stackClear,Stack.prototype["delete"]=_stackDelete,Stack.prototype.get=_stackGet,Stack.prototype.has=_stackHas,Stack.prototype.set=_stackSet;var _Stack=Stack,defineProperty=function(){try{var e=_getNative(Object,"defineProperty");return e({},"",{}),e}catch(t){}}(),_defineProperty=defineProperty;/**
 ...
 */function baseAssignValue(e,t,n){"__proto__"==t&&_defineProperty?_defineProperty(e,t,{configurable:!0,enumerable:!0,value:n,writable:!0}):e[t]=n}var _baseAssignValue=baseAssignValue;/**
 ...
 */function createBaseFor(e){return function(t,n,o){for(var a=-1,i=Object(t),c=o(t),r=c.length;r--;){var l=c[e?r:++a];if(!1===n(i[l],l,i))break}return t}}var _createBaseFor=createBaseFor,baseFor=_createBaseFor(),_baseFor=baseFor,_cloneBuffer=createCommonjsModule(function(e,t){/**
 ...
 */function baseUnary(e){return function(t){return e(t)}}var _baseUnary=baseUnary,_nodeUtil=createCommonjsModule(function(e,t){/** Detect free variable `exports`. */var n=t&&!t.nodeType&&t,o=n&&!0&&e&&!e.nodeType&&e,a=o&&o.exports===n,i=a&&_freeGlobal.process,c=function(){try{// Use `util.types` for Node.js 10+.
var e=o&&o.require&&o.require("util").types;return e?e:i&&i.binding&&i.binding("util");// Legacy `process.binding('util')` for Node.js < 10.
}catch(t){}}();/** Detect free variable `module`. */e.exports=c}),nodeIsTypedArray=_nodeUtil&&_nodeUtil.isTypedArray,isTypedArray=nodeIsTypedArray?_baseUnary(nodeIsTypedArray):_baseIsTypedArray,isTypedArray_1=isTypedArray;/**
 ...
 * @returns {Object} Returns `object`.
 */function copyObject(e,t,n,o){var a=!n;n||(n={});for(var i=-1,c=t.length;++i<c;){var r=t[i],l=o?o(n[r],e[r],r,n,e):void 0;l===void 0&&(l=e[r]),a?_baseAssignValue(n,r,l):_assignValue(n,r,l)}return n}var _copyObject=copyObject;/**
 ...
 */function arrayLikeKeys(e,t){var n=isArray_1(e),o=!n&&isArguments_1(e),a=!n&&!o&&isBuffer_1(e),i=!n&&!o&&!a&&isTypedArray_1(e),c=n||o||a||i,r=c?_baseTimes(e.length,String):[],l=r.length;for(var p in e)(t||hasOwnProperty$7.call(e,p))&&!(c&&(// Safari 9 has enumerable `arguments.length` in strict mode.
...
_isIndex(p,l)))&&r.push(p);return r}var _arrayLikeKeys=arrayLikeKeys;/**
 ...
 *  counterparts.
 */function baseMergeDeep(e,t,n,o,a,i,c){var r=_safeGet(e,n),l=_safeGet(t,n),p=c.get(l);if(p)return void _assignMergeValue(e,n,p);var s=i?i(r,l,n+"",e,t,c):void 0,d=s===void 0;if(d){var y=isArray_1(l),u=!y&&isBuffer_1(l),h=!y&&!u&&isTypedArray_1(l);s=l,y||u||h?isArray_1(r)?s=r:isArrayLikeObject_1(r)?s=_copyArray(r):u?(d=!1,s=_cloneBuffer(l,!0)):h?(d=!1,s=_cloneTypedArray(l,!0)):s=[]:isPlainObject_1(l)||isArguments_1(l)?(s=r,isArguments_1(r)?s=toPlainObject_1(r):(!isObject_1(r)||isFunction_1(r))&&(s=_initCloneObject(l))):d=!1}d&&(c.set(l,s),a(s,l,o,i,c),c["delete"](l)),_assignMergeValue(e,n,s)}var _baseMergeDeep=baseMergeDeep;/**
 ...
 * @param {Object} [stack] Tracks traversed source values and their merged
 *  counterparts.
 */function baseMerge(e,t,n,o,a){e===t||_baseFor(t,function(i,c){if(isObject_1(i))a||(a=new _Stack),_baseMergeDeep(e,t,c,n,baseMerge,o,a);else{var r=o?o(_safeGet(e,c),i,c+"",e,t,a):void 0;r===void 0&&(r=i),_assignMergeValue(e,c,r)}},keysIn_1)}var _baseMerge=baseMerge;/**
 ...
 * @returns {Function} Returns the new function.
 */function overRest(e,t,n){return t=nativeMax(void 0===t?e.length-1:t,0),function(){for(var o=arguments,a=-1,i=nativeMax(o.length-t,0),c=Array(i);++a<i;)c[a]=o[t+a];a=-1;for(var r=Array(t+1);++a<t;)r[a]=o[a];return r[t]=n(c),_apply(e,this,r)}}var _overRest=overRest;/**
 ...
 * // => true
 */function constant(e){return function(){return e}}var constant_1=constant,baseSetToString=_defineProperty?function(e,t){return _defineProperty(e,"toString",{configurable:!0,enumerable:!1,value:constant_1(t),writable:!0})}:identity_1,_baseSetToString=baseSetToString,HOT_COUNT=800,HOT_SPAN=16,nativeNow=Date.now;/**
 ...
 */function createAssigner(e){return _baseRest(function(t,n){var o=-1,a=n.length,i=1<a?n[a-1]:void 0,c=2<a?n[2]:void 0;for(i=3<e.length&&"function"==typeof i?(a--,i):void 0,c&&_isIterateeCall(n[0],n[1],c)&&(i=3>a?void 0:i,a=1),t=Object(t);++o<a;){var r=n[o];r&&e(t,r,o,i)}return t})}var _createAssigner=createAssigner,mergeWith=_createAssigner(function(e,t,n,o){_baseMerge(e,t,n,o)}),mergeWith_1=mergeWith;/**
 ...
 * @param {boolean} [fromRight] Specify iterating from right to left.
 * @returns {Function} Returns the new base function.
 */function createBaseEach(e,t){return function(n,o){if(null==n)return n;if(!isArrayLike_1(n))return e(n,o);for(var a=n.length,i=t?a:-1,c=Object(n);(t?i--:++i<a)&&!(!1===o(c[i],i,c)););return n}}var _createBaseEach=createBaseEach,baseEach=_createBaseEach(_baseForOwn),_baseEach=baseEach;/**
 ...
 */function equalArrays(e,t,n,o,a,i){var c=n&COMPARE_PARTIAL_FLAG,r=e.length,l=t.length;if(r!=l&&!(c&&l>r))return!1;// Assume cyclic values are equal.
var p=i.get(e);if(p&&i.get(t))return p==t;var s=-1,d=!0,y=n&COMPARE_UNORDERED_FLAG?new _SetCache:void 0;// Ignore non-index properties.
for(i.set(e,t),i.set(t,e);++s<r;){var u=e[s],h=t[s];if(o)var m=c?o(h,u,s,t,e,i):o(u,h,s,e,t,i);if(void 0!==m){if(m)continue;d=!1;break}// Recursively compare arrays (susceptible to call stack limits).
if(y){if(!_arraySome(t,function(e,t){if(!_cacheHas(y,t)&&(u===e||a(u,e,n,o,i)))return y.push(t)})){d=!1;break}}else if(!(u===h||a(u,h,n,o,i))){d=!1;break}}return i["delete"](e),i["delete"](t),d}var _equalArrays=equalArrays;/**
...
// for more details.
return e==t+"";case mapTag$1:var r=_mapToArray;case setTag$1:var l=o&COMPARE_PARTIAL_FLAG$1;if(r||(r=_setToArray),e.size!=t.size&&!l)return!1;// Assume cyclic values are equal.
var p=c.get(e);if(p)return p==t;o|=COMPARE_UNORDERED_FLAG$1,c.set(e,t);var s=_equalArrays(r(e),r(t),o,a,i,c);return c["delete"](e),s;case symbolTag:if(symbolValueOf)return symbolValueOf.call(e)==symbolValueOf.call(t);}return!1}var _equalByTag=equalByTag;/**
 ...
 */function arrayFilter(e,t){for(var n=-1,o=null==e?0:e.length,a=0,i=[];++n<o;){var c=e[n];t(c,n,e)&&(i[a++]=c)}return i}var _arrayFilter=arrayFilter;/**
 ...
 * @param {Object} [stack] Tracks traversed `object` and `other` objects.
 * @returns {boolean} Returns `true` if the objects are equivalent, else `false`.
 */function baseIsEqualDeep(e,t,n,o,a,i){var c=isArray_1(e),r=isArray_1(t),l=c?arrayTag$1:_getTag(e),p=r?arrayTag$1:_getTag(t);l=l==argsTag$2?objectTag$3:l,p=p==argsTag$2?objectTag$3:p;var s=l==objectTag$3,d=p==objectTag$3,y=l==p;if(y&&isBuffer_1(e)){if(!isBuffer_1(t))return!1;c=!0,s=!1}if(y&&!s)return i||(i=new _Stack),c||isTypedArray_1(e)?_equalArrays(e,t,n,o,a,i):_equalByTag(e,t,l,n,o,a,i);if(!(n&COMPARE_PARTIAL_FLAG$3)){var u=s&&hasOwnProperty$b.call(e,"__wrapped__"),h=d&&hasOwnProperty$b.call(t,"__wrapped__");if(u||h){var m=u?e.value():e,g=h?t.value():t;return i||(i=new _Stack),a(m,g,n,o,i)}}return!!y&&(i||(i=new _Stack),_equalObjects(e,t,n,o,a,i))}var _baseIsEqualDeep=baseIsEqualDeep;/**
 ...
 */function baseIsMatch(e,t,n,o){var a=n.length,i=a,c=!o;if(null==e)return!i;for(e=Object(e);a--;){var r=n[a];if(c&&r[2]?r[1]!==e[r[0]]:!(r[0]in e))return!1}for(;++a<i;){r=n[a];var l=r[0],p=e[l],s=r[1];if(!(c&&r[2])){var d=new _Stack;if(o)var y=o(p,s,l,e,t,d);if(void 0===y?!_baseIsEqual(s,p,COMPARE_PARTIAL_FLAG$4|COMPARE_UNORDERED_FLAG$2,o,d):!y)return!1}else if(void 0===p&&!(l in e))return!1}return!0}var _baseIsMatch=baseIsMatch;/**
 ...
 */function memoize(e,t){if("function"!=typeof e||null!=t&&"function"!=typeof t)throw new TypeError(FUNC_ERROR_TEXT);var n=function(){var o=arguments,a=t?t.apply(this,o):o[0],i=n.cache;if(i.has(a))return i.get(a);var c=e.apply(this,o);return n.cache=i.set(a,c)||i,c};return n.cache=new(memoize.Cache||_MapCache),n}// Expose `MapCache`.
 ...
 */function hasPath(e,t,n){t=_castPath(t,e);for(var o,a=-1,i=t.length,c=!1;++a<i&&(o=_toKey(t[a]),!!(c=null!=e&&n(e,o)));)e=e[o];return c||++a!=i?c:(i=null==e?0:e.length,!!i&&isLength_1(i)&&_isIndex(o,i)&&(isArray_1(e)||isArguments_1(e)))}var _hasPath=hasPath;/**
 ...
 * }, {});
 * // => { '1': ['a', 'c'], '2': ['b'] }
 */function transform(e,t,n){var o=isArray_1(e),a=o||isBuffer_1(e)||isTypedArray_1(e);if(t=_baseIteratee(t,4),null==n){var i=e&&e.constructor;n=a?o?new i:[]:isObject_1(e)?isFunction_1(i)?_baseCreate(_getPrototype(e)):{}:{}}return(a?_arrayEach:_baseForOwn)(e,function(e,o,a){return t(n,e,o,a)}),n}var transform_1=transform;/**
 ...
 * object === other;
 * // => false
 */function isEqual(e,t){return _baseIsEqual(e,t)}var isEqual_1=isEqual,createNestedObject=function(e,t,n){for(var o,a=t.length-1,c=0;c<a;++c)o=t[c],o in e||(e[o]={}),e=e[o];e[t[a]]=n},multiFn=function(e){for(var t=arguments.length,n=Array(1<t?t-1:0),o=1;o<t;o++)n[o-1]=arguments[o];if(e)if(Array.isArray(e))e.forEach(function(e){return e.apply(void 0,n)});else return e.apply(void 0,n)},composeFn=function(e){return function(){return multiFn(e)}},mergeWithArrayCustomizer=function(e,t){if(isArray_1(e))return e.concat(t)},mergeWithArray=function(e,t){return mergeWith_1(e,t,mergeWithArrayCustomizer)},mergeWithFnCustomizer=function(e,t){if(isFunction_1(e)&&isFunction_1(t))return function(){e.apply(void 0,arguments),t.apply(void 0,arguments)}},mergeWithFn=function(e,t){return mergeWith_1(e,t,mergeWithFnCustomizer)},objectToUrl=function(e){var t="",n=0;return forEach_1(e,function(e,o){t+=(0==n?"?":"&")+o+"="+e,n++}),t},toPrice=function(e,t){return t+""+e.toFixed(2).replace(/./g,function(e,t,n){return 0<t&&"."!==e&&0==(n.length-t)%3?","+e:e})},capitalize=function(e){return e.charAt(0).toUpperCase()+e.slice(1)},escapeICS=function(e){return e.replace(/,/g,"\\,").replace(/:/g,"\\:").replace(/;/g,"\\;")},getPropertyByCaseInsensitiveKey=function(){var e=0<arguments.length&&arguments[0]!==void 0?arguments[0]:{},t=1<arguments.length&&arguments[1]!==void 0?arguments[1]:"",n=findKey_1(e,function(e,n){return n.toLowerCase()===t.toLowerCase()});return e[n]},delayApi=function(){var e=0<arguments.length&&arguments[0]!==void 0?arguments[0]:2e3;return new Promise(function(t){setTimeout(t,e)})},differenceDeep=function(e,t){function n(e,t){return transform_1(e,function(e,o,a){isEqual_1(o,t[a])||(e[a]=isObject_1(o)&&isObject_1(t[a])?n(o,t[a]):o)})}return n(e,t)},divideByProps=function(e,t){var n={},a={};return forEach_1(e,function(e,o){t.hasOwnProperty(o)?a[o]=e:n[o]=e}),[n,a]};function defaultsDeepPreserveArrays(){var e={};return toArray_1(arguments).reverse().forEach(function(t){mergeWith_1(e,t,function(e,t){return isArray_1(t)?t:void 0})}),e}function asyncForEach(){return _asyncForEach.apply(this,arguments)}function _asyncForEach(){return _asyncForEach=asyncToGenerator(/*#__PURE__*/regenerator.mark(function e(t,n){var o;return regenerator.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:o=0;case 1:if(!(o<t.length)){e.next=7;break}return e.next=4,n(t[o],o,t);case 4:o++,e.next=1;break;case 7:case"end":return e.stop();}},e,this)})),_asyncForEach.apply(this,arguments)}var so=function(e,t){return e||t||{}},sa=function(e,t){return e||t||[]},ss=function(e,t){return e||t||""},toSnakeCase=function(e){var t=e.match(/([A-Z])/g);if(!t)return e;for(var o=e.toString(),a=0,c=t.length;a<c;a++)o=o.replace(new RegExp(t[a]),"_"+t[a].toLowerCase());return"_"===o.slice(0,1)&&(o=o.slice(1)),o=o.replace("i_d","id"),o},withShared=function(e,t){return e.shared||(e.shared={}),e.shared.params||(e.shared.params=t),e.state||(e.state={}),e},createNestedObject_1=createNestedObject,multiFn_1=multiFn,composeFn_1=composeFn,mergeWithArray_1=mergeWithArray,mergeWithFn_1=mergeWithFn,objectToUrl_1=objectToUrl,toPrice_1=toPrice,capitalize_1=capitalize,escapeICS_1=escapeICS,getPropertyByCaseInsensitiveKey_1=getPropertyByCaseInsensitiveKey,delayApi_1=delayApi,differenceDeep_1=differenceDeep,defaultsDeepPreserveArrays_1=defaultsDeepPreserveArrays,so_1=so,sa_1=sa,ss_1=ss,toSnakeCase_1=toSnakeCase,withShared_1=withShared,asyncForEach_1=asyncForEach,divideByProps_1=divideByProps,helpers={createNestedObject:createNestedObject_1,multiFn:multiFn_1,composeFn:composeFn_1,mergeWithArray:mergeWithArray_1,mergeWithFn:mergeWithFn_1,objectToUrl:objectToUrl_1,toPrice:toPrice_1,capitalize:capitalize_1,escapeICS:escapeICS_1,getPropertyByCaseInsensitiveKey:getPropertyByCaseInsensitiveKey_1,delayApi:delayApi_1,differenceDeep:differenceDeep_1,defaultsDeepPreserveArrays:defaultsDeepPreserveArrays_1,so:so_1,sa:sa_1,ss:ss_1,toSnakeCase:toSnakeCase_1,withShared:withShared_1,asyncForEach:asyncForEach_1,divideByProps:divideByProps_1},_typeof_1=createCommonjsModule(function(e){function t(e){return t="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},t(e)}function n(o){return e.exports="function"==typeof Symbol&&"symbol"===t(Symbol.iterator)?n=function(e){return t(e)}:n=function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":t(e)},n(o)}e.exports=n}),objectProto$f=Object.prototype,hasOwnProperty$c=objectProto$f.hasOwnProperty;/**
...
//   }
// },
postpatch:function(){console.log("postpatch"),n.actions.componentWillPostpatch&&isFunction$3(n.actions.componentWillPostpatch)&&n.actions.componentWillPostpatch(n.actions.state,n.actions)},insert:function(){console.log("componentDidMount"),n.actions.componentDidMount&&isFunction$3(n.actions.componentDidMount)&&n.actions.componentDidMount(n.actions.state,n.actions)},destroy:function(){console.log("componentWillUnmount"),n.actions.componentWillUnmount&&isFunction$3(n.actions.componentWillUnmount)&&n.actions.componentWillUnmount(n.actions.state,n.actions)},remove:function(e,t){return console.log("componentDidUnmount"),n.actions.componentDidUnmount&&isFunction$3(n.actions.componentDidUnmount)&&n.actions.componentDidUnmount(n.actions.state,n.actions),t()}}}),n.actions.componentDidCreateViewObject&&isFunction$3(n.actions.componentDidCreateViewObject)&&(console.log("componentDidCreateViewObject"),n.actions.componentDidCreateViewObject(n.actions.state,n.actions)),!n.actions.async){e.next=20;break}if(!n.actions.ejectComponent){e.next=19;break}return e.abrupt("return",Promise.resolve(n));case 19:return e.abrupt("return",Promise.resolve(n.nodes.view));case 20:if(!n.actions.ejectComponent){e.next=22;break}return e.abrupt("return",n);case 22:return e.abrupt("return",n.nodes.view);case 23:case"end":return e.stop();}},e,this)}));return function(){return e.apply(this,arguments)}}(),componentAsync=lazy_1(createAsyncComponent,loader),src=component,h_1=h,lazy_1$1=lazy_1,patch_1=patch,styled_1=styled,createAsyncComponent_1=componentAsync;src.h=h_1,src.lazy=lazy_1$1,src.patch=patch_1,src.styled=styled_1,src.createAsyncComponent=createAsyncComponent_1,exports.default=src,exports.h=h_1,exports.lazy=lazy_1$1,exports.patch=patch_1,exports.styled=styled_1,exports.createAsyncComponent=createAsyncComponent_1;
