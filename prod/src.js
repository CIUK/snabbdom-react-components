import lodash,{forEach,isArray,isString,has}from"lodash";var commonjsGlobal="undefined"==typeof window?"undefined"==typeof global?"undefined"==typeof self?{}:self:global:window;function createCommonjsModule(e,t){return t={exports:{}},e(t,t.exports),t.exports}var runtime=createCommonjsModule(function(e){/**
...
var i=t&&t.prototype instanceof a?t:a,c=Object.create(i.prototype),r=new h(o||[]);return c._invoke=p(e,n,r),c}// Try/catch helper to minimize deoptimizations. Returns a completion
...
return g()}for(n.method=i,n.arg=c;;){var r=n.delegate;if(r){var l=s(r,n);if(l){if(l===v)continue;return l}}if("next"===n.method)// Setting context._sent for legacy support of Babel's
...
return{next:g}}function g(){return{value:void 0,done:!0}}var m=Object.prototype,f=m.hasOwnProperty,k="function"==typeof Symbol?Symbol:{},_=k.iterator||"@@iterator",b=k.asyncIterator||"@@asyncIterator",x=k.toStringTag||"@@toStringTag",w=t.regeneratorRuntime;if(w)// Don't bother evaluating the rest of this file if the runtime was
...
w=t.regeneratorRuntime=e.exports,w.wrap=n;var v={},j={};j[_]=function(){return this};var W=Object.getPrototypeOf,C=W&&W(W(u([])));C&&C!==m&&f.call(C,_)&&(j=C);var O=c.prototype=a.prototype=Object.create(j);// Within the body of any async function, `await x` is transformed to
...
:i.next().then(function(e){return e.done?e.value:i.next()})},r(O),O[x]="Generator",O[_]=function(){return this},O.toString=function(){return"[object Generator]"},w.keys=function(e){var t=[];for(var n in e)t.push(n);// Rather than returning an object with a next method, we keep
...
return n.done=!0,n}},w.values=u,h.prototype={constructor:h,reset:function(e){if(this.prev=0,this.next=0,this.sent=this._sent=void 0,this.done=!1,this.delegate=null,this.method="next",this.arg=void 0,this.tryEntries.forEach(y),!e)for(var t in this)// Not sure about the optimal order of these conditions:
...
throw new Error("illegal catch attempt")},delegateYield:function(e,t,n){return this.delegate={iterator:u(e),resultName:t,nextLoc:n},"next"===this.method&&(this.arg=void 0),v}}}(// In sloppy mode, unbound `this` refers to the global object, fallback to
...
var d=s.indexOf("#"),y=s.indexOf(".",d),u=0<d?d:s.length,g=0<y?y:s.length,m=-1!==d||-1!==y?s.slice(0,o(u,g)):s;if(l=e.elm=isDef(r)&&isDef(c=r.ns)?t.createElementNS(c,m):t.createElement(m),u<g&&(l.id=s.slice(u+1,g)),0<y&&(l.className=s.slice(g+1).replace(/\./g," ")),is.array(p))for(c=0;c<p.length;++c)t.appendChild(l,a(p[c],n));else is.primitive(e.text)&&t.appendChild(l,t.createTextNode(e.text));for(c=0;c<h.create.length;++c)h.create[c](emptyNode,e);c=e.data.hook,isDef(c)&&(c.create&&c.create(emptyNode,e),c.insert&&n.push(e))}else l=e.elm=t.createTextNode(e.text);return e.elm}function c(e,n,o,i,c,r){for(;i<=c;++i)t.insertBefore(e,a(o[i],r),n)}function r(e){var t,n,o=e.data;if(isDef(o)){for(isDef(t=o.hook)&&isDef(t=t.destroy)&&t(e),t=0;t<h.destroy.length;++t)h.destroy[t](e);if(isDef(t=e.children))for(n=0;n<e.children.length;++n)r(e.children[n])}}function l(e,n,a,c){for(;a<=c;++a){var l,p,s,d=n[a];if(isDef(d))if(isDef(d.sel)){for(r(d),p=h.remove.length+1,s=o(d.elm,p),l=0;l<h.remove.length;++l)h.remove[l](d,s);isDef(l=d.data)&&isDef(l=l.hook)&&isDef(l=l.remove)?l(d,s):s()}else// Text node
t.removeChild(e,d.elm)}}function p(e,n,o,i){for(var r,p,d,y,h=0,u=0,g=n.length-1,m=n[0],f=n[g],k=o.length-1,_=o[0],b=o[k];h<=g&&u<=k;)isUndef(m)?m=n[++h]:isUndef(f)?f=n[--g]:sameVnode(m,_)?(s(m,_,i),m=n[++h],_=o[++u]):sameVnode(f,b)?(s(f,b,i),f=n[--g],b=o[--k]):sameVnode(m,b)?(// Vnode moved right
s(m,b,i),t.insertBefore(e,m.elm,t.nextSibling(f.elm)),m=n[++h],b=o[--k]):sameVnode(f,_)?(// Vnode moved left
s(f,_,i),t.insertBefore(e,f.elm,m.elm),f=n[--g],_=o[++u]):(isUndef(r)&&(r=createKeyToOldIdx(n,h,g)),p=r[_.key],isUndef(p)?(t.insertBefore(e,a(_,i),m.elm),_=o[++u]):(d=n[p],s(d,_,i),n[p]=void 0,t.insertBefore(e,d.elm,m.elm),_=o[++u]));h>g?(y=isUndef(o[k+1])?null:o[k+1].elm,c(e,y,o,u,k,i)):u>k&&l(e,n,h,g)}function s(e,n,o){var r,s;isDef(r=n.data)&&isDef(s=r.hook)&&isDef(r=s.prepatch)&&r(e,n);var d=n.elm=e.elm,y=e.children,u=n.children;if(e!==n){if(!sameVnode(e,n)){var g=t.parentNode(e.elm);return d=a(n,o),t.insertBefore(g,d,e.elm),void l(g,[e],0,0)}if(isDef(n.data)){for(r=0;r<h.update.length;++r)h.update[r](e,n);r=n.data.hook,isDef(r)&&isDef(r=r.update)&&r(e,n)}isUndef(n.text)?isDef(y)&&isDef(u)?y!==u&&p(d,y,u,o):isDef(u)?(isDef(e.text)&&t.setTextContent(d,""),c(d,null,u,0,u.length-1,o)):isDef(y)?l(d,y,0,y.length-1):isDef(e.text)&&t.setTextContent(d,""):e.text!==n.text&&t.setTextContent(d,n.text),isDef(s)&&isDef(r=s.postpatch)&&r(e,n)}}var d,y,h={};for(isUndef(t)&&(t=htmldomapi),d=0;d<hooks.length;++d)for(h[hooks[d]]=[],y=0;y<e.length;++y)void 0!==e[y][hooks[d]]&&h[hooks[d]].push(e[y][hooks[d]]);return function(e,o){var c,r,p,d=[];for(c=0;c<h.pre.length;++c)h.pre[c]();for(isUndef(e.sel)&&(e=n(e)),sameVnode(e,o)?s(e,o,d):(r=e.elm,p=t.parentNode(r),a(o,d),null!==p&&(t.insertBefore(p,o.elm,t.nextSibling(r)),l(p,[e],0,0))),c=0;c<d.length;++c)d[c].data.hook.insert(d[c]);for(c=0;c<h.post.length;++c)h.post[c]();return o}}var snabbdom={init:init};function updateClass(e,t){var n,o,a=t.elm,i=e.data.class||{},c=t.data.class||{};for(o in i)c[o]||a.classList.remove(o);for(o in c)n=c[o],n!==i[o]&&a.classList[n?"add":"remove"](o)}var _class={create:updateClass,update:updateClass};function updateProps(e,t){var n,o,a,i=t.elm,c=e.data.props||{},r=t.data.props||{};for(n in c)r[n]||delete i[n];for(n in r)o=r[n],a=c[n],a!==o&&("value"!==n||i[n]!==o)&&(i[n]=o)}for(var props={create:updateProps,update:updateProps},booleanAttrs=["allowfullscreen","async","autofocus","autoplay","checked","compact","controls","declare","default","defaultchecked","defaultmuted","defaultselected","defer","disabled","draggable","enabled","formnovalidate","hidden","indeterminate","inert","ismap","itemscope","loop","multiple","muted","nohref","noresize","noshade","novalidate","nowrap","open","pauseonexit","readonly","required","reversed","scoped","seamless","selected","sortable","spellcheck","translate","truespeed","typemustmatch","visible"],booleanAttrsDict={},i=0,len=booleanAttrs.length;i<len;i++)booleanAttrsDict[booleanAttrs[i]]=!0;function updateAttrs(e,t){var n,o,a,i=t.elm,c=e.data.attrs||{},r=t.data.attrs||{};// update modified attributes, add new attributes
 ...
 */function baseIsArguments(e){return isObjectLike_1(e)&&_baseGetTag(e)==argsTag}var _baseIsArguments=baseIsArguments,objectProto$6=Object.prototype,hasOwnProperty$4=objectProto$6.hasOwnProperty,propertyIsEnumerable=objectProto$6.propertyIsEnumerable,isArguments=_baseIsArguments(function(){return arguments}())?_baseIsArguments:function(e){return isObjectLike_1(e)&&hasOwnProperty$4.call(e,"callee")&&!propertyIsEnumerable.call(e,"callee")},isArguments_1=isArguments,isArray$2=Array.isArray,isArray_1=isArray$2,MAX_SAFE_INTEGER=9007199254740991;/** Used for built-in method references. */ /**
 ...
 *  counterparts.
 */function baseMergeDeep(e,t,n,o,a,i,c){var r=_safeGet(e,n),l=_safeGet(t,n),p=c.get(l);if(p)return void _assignMergeValue(e,n,p);var s=i?i(r,l,n+"",e,t,c):void 0,d=s===void 0;if(d){var y=isArray_1(l),h=!y&&isBuffer_1(l),u=!y&&!h&&isTypedArray_1(l);s=l,y||h||u?isArray_1(r)?s=r:isArrayLikeObject_1(r)?s=_copyArray(r):h?(d=!1,s=_cloneBuffer(l,!0)):u?(d=!1,s=_cloneTypedArray(l,!0)):s=[]:isPlainObject_1(l)||isArguments_1(l)?(s=r,isArguments_1(r)?s=toPlainObject_1(r):(!isObject_1(r)||isFunction_1(r))&&(s=_initCloneObject(l))):d=!1}d&&(c.set(l,s),a(s,l,o,i,c),c["delete"](l)),_assignMergeValue(e,n,s)}var _baseMergeDeep=baseMergeDeep;/**
 ...
 */function forEach$1(e,t){var n=isArray_1(e)?_arrayEach:_baseEach;return n(e,_castFunction(t))}var forEach_1=forEach$1;/**
...
for(i.set(e,t),i.set(t,e);++s<r;){var h=e[s],u=t[s];if(o)var g=c?o(u,h,s,t,e,i):o(h,u,s,e,t,i);if(void 0!==g){if(g)continue;d=!1;break}// Recursively compare arrays (susceptible to call stack limits).
if(y){if(!_arraySome(t,function(e,t){if(!_cacheHas(y,t)&&(h===e||a(h,e,n,o,i)))return y.push(t)})){d=!1;break}}else if(!(h===u||a(h,u,n,o,i))){d=!1;break}}return i["delete"](e),i["delete"](t),d}var _equalArrays=equalArrays;/**
 ...
 * @param {Object} [stack] Tracks traversed `object` and `other` objects.
 * @returns {boolean} Returns `true` if the objects are equivalent, else `false`.
 */function baseIsEqualDeep(e,t,n,o,a,i){var c=isArray_1(e),r=isArray_1(t),l=c?arrayTag$1:_getTag(e),p=r?arrayTag$1:_getTag(t);l=l==argsTag$2?objectTag$3:l,p=p==argsTag$2?objectTag$3:p;var s=l==objectTag$3,d=p==objectTag$3,y=l==p;if(y&&isBuffer_1(e)){if(!isBuffer_1(t))return!1;c=!0,s=!1}if(y&&!s)return i||(i=new _Stack),c||isTypedArray_1(e)?_equalArrays(e,t,n,o,a,i):_equalByTag(e,t,l,n,o,a,i);if(!(n&COMPARE_PARTIAL_FLAG$3)){var h=s&&hasOwnProperty$b.call(e,"__wrapped__"),u=d&&hasOwnProperty$b.call(t,"__wrapped__");if(h||u){var g=h?e.value():e,m=u?t.value():t;return i||(i=new _Stack),a(g,m,n,o,i)}}return!!y&&(i||(i=new _Stack),_equalObjects(e,t,n,o,a,i))}var _baseIsEqualDeep=baseIsEqualDeep;/**
 ...
 * _.isString(1);
 * // => false
 */function isString$2(e){return"string"==typeof e||!isArray_1(e)&&isObjectLike_1(e)&&_baseGetTag(e)==stringTag$2}var isString_1=isString$2;/**
...
//   }
// },
postpatch:function(){console.log("postpatch"),n.actions.componentWillPostpatch&&isFunction$3(n.actions.componentWillPostpatch)&&n.actions.componentWillPostpatch(n.actions.state,n.actions)},insert:function(){console.log("componentDidMount"),n.actions.componentDidMount&&isFunction$3(n.actions.componentDidMount)&&n.actions.componentDidMount(n.actions.state,n.actions)},destroy:function(){console.log("componentWillUnmount"),n.actions.componentWillUnmount&&isFunction$3(n.actions.componentWillUnmount)&&n.actions.componentWillUnmount(n.actions.state,n.actions)},remove:function(e,t){return console.log("componentDidUnmount"),n.actions.componentDidUnmount&&isFunction$3(n.actions.componentDidUnmount)&&n.actions.componentDidUnmount(n.actions.state,n.actions),t()}}}),n.actions.componentDidCreateViewObject&&isFunction$3(n.actions.componentDidCreateViewObject)&&(console.log("componentDidCreateViewObject"),n.actions.componentDidCreateViewObject(n.actions.state,n.actions)),!n.actions.async){e.next=20;break}if(!n.actions.ejectComponent){e.next=19;break}return e.abrupt("return",Promise.resolve(n));case 19:return e.abrupt("return",Promise.resolve(n.nodes.view));case 20:if(!n.actions.ejectComponent){e.next=22;break}return e.abrupt("return",n);case 22:return e.abrupt("return",n.nodes.view);case 23:case"end":return e.stop();}},e,this)}));return function(){return e.apply(this,arguments)}}(),componentAsync=lazy_1(createAsyncComponent,loader),css$1=styled.css,cssWithProps$1=styled.cssWithProps,cssWithPropsPlain$1=styled.cssWithPropsPlain,src=component,h_1=h,css_1=css$1,lazy_1$1=lazy_1,patch_1=patch,styled_1=styled,cssWithProps_1=cssWithProps$1,cssWithPropsPlain_1=cssWithPropsPlain$1,createAsyncComponent_1=componentAsync;src.h=h_1,src.css=css_1,src.lazy=lazy_1$1,src.patch=patch_1,src.styled=styled_1,src.cssWithProps=cssWithProps_1,src.cssWithPropsPlain=cssWithPropsPlain_1,src.createAsyncComponent=createAsyncComponent_1;export default src;export{h_1 as h,css_1 as css,lazy_1$1 as lazy,patch_1 as patch,styled_1 as styled,cssWithProps_1 as cssWithProps,cssWithPropsPlain_1 as cssWithPropsPlain,createAsyncComponent_1 as createAsyncComponent};
