...
var actions = function actions(viewObject) {
  ...
  forEach$1(items, function (item, name) {
    if (isFunction$2(item)) {
      items[name] = function () {
        ...
        return item.apply(void 0, args.concat([viewObject.actions.state, viewObject.actions]));
      };
    }
  });
...
var componentFn = function componentFn(viewObject) {
  ...
  var profileHook = function profileHook(hook) {
    var types = uniq(map(hook, function (hk) {
      var type = _typeof_1(hk);
...
var actions$1 = function actions(viewObject) {
  ...
  forEach$2(items, function (item, name) {
...
var componentFn$1 = function componentFn(viewObject) {
  ...
  var profileHook = function profileHook(hook) {
    var types = uniq$1(map$1(hook, function (hk) {
      var type = _typeof_1(hk);
...
var toVNode = function toVNode(textOrVNode) {
  if (_typeof_1(textOrVNode) === 'object') return textOrVNode;
  return {
    children: undefined,
    data: undefined,
    elm: undefined,
...
var isVNode = function isVNode(vnode) {
  if (isObject_1(vnode) && has_1(vnode, 'children') && has_1(vnode, 'data') && has_1(vnode, 'sel') && has_1(vnode, 'elm') && has_1(vnode, 'key') && has_1(vnode, 'text')) {
    return true;
  }

  if (isObject_1(vnode) && has_1(vnode, 'children') && has_1(vnode, 'data') && has_1(vnode, 'sel')) {
    return true;
  }
...
var isDefinedValue = function isDefinedValue(value) {
  return !isUndefined_1(value) && !isNull_1(value);
};
...
var isDefinedChild = function isDefinedChild(value) {
  return !isGhost(value) || !isUndefined_1(value) && !isNull_1(value) && (isObject_1(value) ? isArray_1(value) : true);
};
...
var isDefinedValue_1 = isDefinedValue;
var isGhost_1 = isGhost;
var isDefinedChild_1 = isDefinedChild;
var vDomHelpers = {
  toVNode: toVNode_1,
  isVNode: isVNode_1,
  trustHTML: trustHTML_1,
  JsonToVNode: JsonToVNode_1,
  isDefinedValue: isDefinedValue_1,
  isGhost: isGhost_1,
  isDefinedChild: isDefinedChild_1
};

var forEach$3 = lodash.forEach,
    has$1 = lodash.has,
    filter = lodash.filter,
    defaultsDeep$2 = lodash.defaultsDeep,
    isArray$4 = lodash.isArray;
var mergeWithFn$1 = helpers.mergeWithFn,
    ss$1 = helpers.ss;
var isDefinedChild$1 = vDomHelpers.isDefinedChild,
...
var getVNode = function getVNode() {
  ...
  return function () {
    var d = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : defaultData;
    var c = arguments.length > 1 ? arguments[1] : undefined;
    var data = d;
    var children = c;

    if (!children && isDefinedChild$1(data)) {
      children = data;
      data = objectSpread({}, defaultData);
    } else {
      data = defaultsDeep$2(data, defaultData);
    }

    var props = data.styled;
    var css = cssWithPropsPlain(props, data).apply(void 0, [literals].concat(expressions));
    var style = cssToJS(css);
    var defprops = {
      style: style,
      styledProps: {
        css: css
    ...
    if (isArray$4(children)) {
      children = filter(children, function (child) {
        return isDefinedChild$1(child);
      });
    } else if (!isDefinedChild$1(children)) {
      children = [];
    }
...
var execFuncArgs = function execFuncArgs(arg) {
  if (typeof arg === 'function') {
    ...
    if (props.length) {
      return ss$1(arg.apply(void 0, props));
    }
...
var cssPlain = function cssPlain(literals) {
...
var css = function css(literals) {
  ...
  return cssToJS(cssPlain.apply(void 0, [literals].concat(expressions)));
};

var cssWithPropsPlain = function cssWithPropsPlain() {
  ...
  return function (literals) {
    ...
    forEach$3(literals, function (literal, i) {
      if (expressions[i]) {
        styles += "".concat(literal).concat(execFuncArgs.apply(void 0, [expressions[i]].concat(props)));
      } else {
        styles += literal;
      }
    });
...
var cssWithProps = function cssWithProps() {
  ...
  return function (literals) {
    ...
    return cssToJS(cssWithPropsPlain.apply(void 0, props).apply(void 0, [literals].concat(expressions)));
  };
};
...
var selector = function selector() {
  ...
  for (var _len9 = arguments.length, expressions = new Array(_len9 > 2 ? _len9 - 2 : 0), _key9 = 2; _key9 < _len9; _key9++) {
    expressions[_key9 - 2] = arguments[_key9];
  }
...
var styled = {
  ...
  ul: function ul(literals) {
    for (var _len120 = arguments.length, expressions = new Array(_len120 > 1 ? _len120 - 1 : 0), _key120 = 1; _key120 < _len120; _key120++) {
      expressions[_key120 - 1] = arguments[_key120];
    }

    return selector.apply(void 0, ['ul', literals].concat(expressions));
  },
  var: function _var(literals) {
    for (var _len121 = arguments.length, expressions = new Array(_len121 > 1 ? _len121 - 1 : 0), _key121 = 1; _key121 < _len121; _key121++) {
      expressions[_key121 - 1] = arguments[_key121];
    }

    return selector.apply(void 0, ['var', literals].concat(expressions));
  },
  video: function video(literals) {
    for (var _len122 = arguments.length, expressions = new Array(_len122 > 1 ? _len122 - 1 : 0), _key122 = 1; _key122 < _len122; _key122++) {
      expressions[_key122 - 1] = arguments[_key122];
    }

    return selector.apply(void 0, ['video', literals].concat(expressions));
  },
  wbr: function wbr(literals) {
    for (var _len123 = arguments.length, expressions = new Array(_len123 > 1 ? _len123 - 1 : 0), _key123 = 1; _key123 < _len123; _key123++) {
      expressions[_key123 - 1] = arguments[_key123];
    }
