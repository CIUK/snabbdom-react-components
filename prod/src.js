...
return{next:m}}function m(){return{value:void 0,done:!0}}var g=Object.prototype,f=g.hasOwnProperty,k="function"==typeof Symbol?Symbol:{},_=k.iterator||"@@iterator",b=k.asyncIterator||"@@asyncIterator",x=k.toStringTag||"@@toStringTag",w=t.regeneratorRuntime;if(w)// Don't bother evaluating the rest of this file if the runtime was
...
w=t.regeneratorRuntime=e.exports,w.wrap=n;var v={},j={};j[_]=function(){return this};var W=Object.getPrototypeOf,C=W&&W(W(u([])));C&&C!==g&&f.call(C,_)&&(j=C);var S=c.prototype=a.prototype=Object.create(j);// Within the body of any async function, `await x` is transformed to
...
i.prototype=S.constructor=c,c.constructor=i,c[x]=i.displayName="GeneratorFunction",w.isGeneratorFunction=function(e){var t="function"==typeof e&&e.constructor;return!!t&&(t===i||// For the native GeneratorFunction constructor, the best we can
// do is to check its .name property.
"GeneratorFunction"===(t.displayName||t.name))},w.mark=function(e){return Object.setPrototypeOf?Object.setPrototypeOf(e,c):(e.__proto__=c,!(x in e)&&(e[x]="GeneratorFunction")),e.prototype=Object.create(S),e},w.awrap=function(e){return{__await:e}},r(l.prototype),l.prototype[b]=function(){return this},w.AsyncIterator=l,w.async=function(e,t,o,a){var i=new l(n(e,t,o,a));return w.isGeneratorFunction(t)?i// If outerFn is a generator, return the full iterator.
:i.next().then(function(e){return e.done?e.value:i.next()})},r(S),S[x]="Generator",S[_]=function(){return this},S.toString=function(){return"[object Generator]"},w.keys=function(e){var t=[];for(var n in e)t.push(n);// Rather than returning an object with a next method, we keep
...
var h=i.get(e);if(h&&i.get(t))return h==t;var u=!0;i.set(e,t),i.set(t,e);for(var m=c;++y<l;){d=r[y];var g=e[d],f=t[d];if(o)var k=c?o(f,g,d,t,e,i):o(g,f,d,e,t,i);// Recursively compare objects (susceptible to call stack limits).
if(void 0===k?!(g===f||a(g,f,n,o,i)):!k){u=!1;break}m||(m="constructor"==d)}if(u&&!m){var _=e.constructor,b=t.constructor;// Non `Object` object instances with different constructors are not equal.
