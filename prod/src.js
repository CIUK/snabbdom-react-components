...
v=t.regeneratorRuntime=e.exports,v.wrap=n;var w={},j={};j[_]=function(){return this};var W=Object.getPrototypeOf,C=W&&W(W(u([])));C&&C!==g&&f.call(C,_)&&(j=C);var O=c.prototype=a.prototype=Object.create(j);// Within the body of any async function, `await x` is transformed to
...
i.prototype=O.constructor=c,c.constructor=i,c[x]=i.displayName="GeneratorFunction",v.isGeneratorFunction=function(e){var t="function"==typeof e&&e.constructor;return!!t&&(t===i||// For the native GeneratorFunction constructor, the best we can
// do is to check its .name property.
"GeneratorFunction"===(t.displayName||t.name))},v.mark=function(e){return Object.setPrototypeOf?Object.setPrototypeOf(e,c):(e.__proto__=c,!(x in e)&&(e[x]="GeneratorFunction")),e.prototype=Object.create(O),e},v.awrap=function(e){return{__await:e}},r(l.prototype),l.prototype[b]=function(){return this},v.AsyncIterator=l,v.async=function(e,t,o,a){var i=new l(n(e,t,o,a));return v.isGeneratorFunction(t)?i// If outerFn is a generator, return the full iterator.
:i.next().then(function(e){return e.done?e.value:i.next()})},r(O),O[x]="Generator",O[_]=function(){return this},O.toString=function(){return"[object Generator]"},v.keys=function(e){var t=[];for(var n in e)t.push(n);// Rather than returning an object with a next method, we keep
